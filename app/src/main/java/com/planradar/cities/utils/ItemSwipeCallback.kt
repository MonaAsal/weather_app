package com.planradar.cities.utils
...
import com.planradar.cities.ui.cities.citiesList.CitiesListAdapter

class ItemSwipeCallback(
    private var adapter: CitiesListAdapter,
    ...
    private var background: ColorDrawable =
        ColorDrawable(ContextCompat.getColor(context, R.color.colorDanger))
